...
public abstract class HandModel : MonoBehaviour {
  ...
  * @returns A Quaternion representing the rotation of the hand in global coordinates. 
  */
  ...
  * @returns A Vector3 representing the direction of the hand in global coordinates.
  */
  ...
  * @returns A Quaternion representing the rotation of the arm in global coordinates. 
  */
